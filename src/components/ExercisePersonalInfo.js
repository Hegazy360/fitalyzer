...
function ExercisePersonalInfo(props) {
  const exercisePR = maxBy([...new Set([].concat(...props.activeExerciseSet.map(exercise => exercise.sets)))],'weight')
  return (
    <Statistic.Group widths='four'>
      ...
      <Statistic>
        ...
        <Statistic.Label>Internationl Average</Statistic.Label>
      </Statistic>

      <Statistic>
        <Statistic.Value>
          {props.activeExerciseSet.length}
        </Statistic.Value>
